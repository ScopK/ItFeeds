(function() {
	...
	css  += "	width: 211px;";
	css  += "	padding: 2px;";
	css  += "	box-shadow: 3px 3px 2px rgba(0,0,0,0.5);";
	css  += "	z-index:3;";
	css  += "}";
	css  += ".cm-item{";
	css  += "	border: 1px solid transparent;";
	css  += "	padding:1px 7px 2px;";
	css  += "	font-size: 12px;";
	...
	css  += "	background-color:#d1e2f2;";
	css  += "	border-color: #78aee5;";
	css  += "}";
	css  +=  "#contextual-menu hr,.contextual-folder hr{";
	css  += "	border:solid #d7d7d7;";
	css  += "	border-width:0 0 1px 0;";
	css  += "	margin: 1px 1px 2px;";
	css  += "}";
	style.innerHTML = css;
