...
function loadFolders(user){
	...
	$.ajax({
		...
		type: "GET",
		data: "level=2&user="+user,
		dataType : "json",
		success: function(result){
			folders = result.folders;
			tags = result.tags;
			console.log(tags);
			$(".logoutButton").html("User_ "+user);
			load(folders);
			loadTags(tags);
			loading_stop();
		},
